  ...
  return (
    <>
      ...
      >
        <div className={classes.container}>
          <div className={classes.header}>
            <Typography variant='subtitle1'>Tasks Archives</Typography>
          </div>
          <div className={classes.innerItems}>
            ...
            {lists.archivedTasks && lists.archivedTasks.length === 0 && (
              <div className={classes.emptyArchive}>0 Tasks Archives</div>
            )}
          </div>
        </div>
      </Popover>
      ...
      <DeleteMenu
        ...
        headerTitle='Supprimer task?'
        handleClose={closeDeleteMenu}
        deleteHandle={deleteTaskHandle}
        text={'La suppression d un task est irreversible ,Etes-vous sur?'}
      />
    </>
  );
};
