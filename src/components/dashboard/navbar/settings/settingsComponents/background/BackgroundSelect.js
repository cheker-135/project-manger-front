...
const BackgroundSelect = ({ backgroundTheme, open, projectId }) => {
  ...
  return (
    <div className={classes.container}>
      ...
      >
        <Typography variant='subtitle2'>Selectionner une Arriere-plan</Typography>
      </div>
      ...
      <div style={{ width: '100%' }}>
        <div className={classes.heading} style={{ justifyContent: 'center' }}>
          <Typography variant='subtitle2'>Ou telecharger votre photo</Typography>
        </div>
        <div
        ...
        {error && (
          <Alert severity='error' style={{ marginTop: 10 }}>
            Une erreur s'est produite,Essayer de nouveau plus tard
          </Alert>
        )}
      </div>
    </div>
